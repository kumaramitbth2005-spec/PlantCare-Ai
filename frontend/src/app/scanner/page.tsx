                ...
                <div className="xl:col-span-7 space-y-8">
                    <div
                        ...
                        className={cn(
                            ...
                            "justify-center min-h-[400px] cursor-pointer shadow-sm",
                            isDragActive
                    ...
                    <AnimatePresence mode="wait">
                        {result ? (
                            <motion.div
                                ...
                                className={cn(
                                    "glass-card h-full p-10 space-y-10 bg-white dark:bg-[#1a1215]",
                            ...
                            >
                                <div className="flex items-start justify-between">
                                    <div className="space-y-3">
                                        ...
                                        <h2 className="text-5xl font-black text-slate-900 dark:text-white tracking-tighter capitalize leading-none">{result.plant}</h2>
                                    </div>
                                    <div className={cn(
                                        "bg-slate-50 dark:bg-pink-500/5 p-5 rounded-[2rem]",
                                        "border border-slate-100 dark:border-pink-500/10 flex flex-col",
                                        "items-center justify-center min-w-[100px] shadow-inner"
                                    )}>
                                        <span className="text-4xl font-black text-pink-600 dark:text-pink-400">{result.confidence}%</span>
                                        <span className="text-[9px] font-black text-slate-400 uppercase tracking-widest mt-1">Confidence</span>
                                    </div>
                                </div>

                                <div className={cn(
                                    "p-8 rounded-[2.5rem] flex items-center gap-6 border-b-4",
                                    ...
                                    <div className={cn(
                                        ...
                                        {(result.disease || "").toLowerCase() === 'healthy' ? <CheckCircle2 className="w-10 h-10" /> : <AlertCircle className="w-10 h-10" />}
                                    </div>
                                    <div>
                                        <p className="text-[10px] font-black uppercase tracking-[0.2em] opacity-50 mb-1">Diagnosis Findings</p>
                                        <p className="text-3xl font-black leading-tight tracking-tight">{result.disease}</p>
                                    </div>
                                </div>
